...
public class MiddleOverAndBackNoScore extends SequentialCommandGroup {
  /** Creates a new MiddleOverAndBack. */
  public MiddleOverAndBackNoScore(ActiveIntake intake, SwerveDrivetrain drivetrain, Claw claw, ClawPitch clawPitch, Elevator elevator, AutonPaths paths) {
