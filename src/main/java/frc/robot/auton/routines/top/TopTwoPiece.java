...
public class TopTwoPiece extends SequentialCommandGroup {
  /** Creates a new TopTwoPiece. */
  public TopTwoPiece(ActiveIntake intake, Claw claw, ClawPitch clawPitch, Elevator elevator, AutonPaths paths) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ScoreCubeHigh(elevator, claw, clawPitch, intake),
      new PlaceCube(elevator, claw, clawPitch, intake),
      paths.followTrajectoryCommand(paths.getTrajectory(AutoTrajectory.GetGamepieceOne)),
