...
public class TopPlaceAndTaxi extends SequentialCommandGroup {
  /** Creates a new TopPlaceAndTaxi. */
  public TopPlaceAndTaxi(SwerveDrivetrain drivetrain, ActiveIntake intake, Claw claw, ClawPitch clawPitch, Elevator elevator, AutonPaths paths) {
