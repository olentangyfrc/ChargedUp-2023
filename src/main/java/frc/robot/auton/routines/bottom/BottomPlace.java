...
public class BottomPlace extends SequentialCommandGroup {
  /** Creates a new TopPlace. */
  public BottomPlace(SwerveDrivetrain drivetrain, ActiveIntake intake, Claw claw, ClawPitch clawPitch, Elevator elevator) {
