...
public class DriveOntoChargeStation extends CommandBase {
  ...
  public static final double TIME_TO_DRIVE = 5.5;
  private double startTime;

  /** Creates a new autoBalance. */
  public DriveOntoChargeStation(SwerveDrivetrain drivetrain) {
  ...
  @Override
  public void execute() {
    drivetrain.drive(new ChassisSpeeds(0.5 * ((DriverStation.getAlliance() == Alliance.Blue)? 1 : -1), 0, 0), true);
  }
